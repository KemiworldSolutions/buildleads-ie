...
SEGMENT_BLURBS = {
    "roofing": {
        ...
        "intro": "Dublin's four councils approve hundreds of extensions, loft conversions, and re-roofs every month. BuildLeads pulls every relevant application from the public weekly lists and emails them to you every Monday morning. €29/month. No middlemen.",
    ...
    "solar_pv": {
        ...
        "intro": "SEAI grants made Dublin the most competitive solar PV market in Ireland. BuildLeads gives you every Dublin household at planning stage — the exact moment they're spending on the house and most likely to add PV.",
    ...
    "structural_engineering": {
        ...
        "intro": "Small structural practices spend 30% of their week chasing work. BuildLeads sends you a weekly digest of every Dublin application that's going to need structural certification — sourced direct from the four council registers.",
    ...
    "architecture": {
        ...
        "intro": "If you're a small Dublin practice taking on overflow design or technician work, BuildLeads tells you which other Dublin architects just filed substantial applications and which projects have no agent listed at all.",
    ...
    "kitchens": {
        ...
        "intro": "Most rear extensions in Dublin end with a new kitchen. BuildLeads sends you every Dublin extension at planning stage, weeks before the homeowner starts ringing showrooms.",
    ...
    "windows_glazing": {
        ...
        "intro": "If it has windows, it'll need a glazier. BuildLeads pulls every Dublin application that mentions glazing, rooflights, sliding doors or replacement windows.",
    ...
    "insulation": {
        ...
        "intro": "Every renovation in Dublin is also an insulation opportunity. BuildLeads sends you the planning applications first.",
        "long_tail": "insulation contractor leads Dublin, SEAI insulation leads",
    },
    "scaffolding": {
        "h1": "Every Dublin job that's about to need scaffolding.",
        "intro": "Two-storey extension? Re-roof? Render job? Scaffolding required. BuildLeads tells you who and where, before the main contractor is even appointed.",
...
nav{font-size:.9rem;margin-bottom:1.5rem;display:flex;flex-wrap:wrap;align-items:center;gap:.4rem .75rem}
.nav-logo{font-weight:700;font-size:1rem;color:#1a1a1a;text-decoration:none;flex:0 0 100%}
.nav-links{display:flex;flex-wrap:wrap;gap:.25rem .75rem}
@media(min-width:768px){.nav-logo{flex:0 0 auto}}
...
{{
  ...
  "provider":{{"@type":"Organization","name":"BuildLeads.ie"}},
...
<body>
<nav><a class="nav-logo" href="/">BuildLeads.ie</a><div class="nav-links"><a href="/r/roofing.html">Roofing</a><a href="/r/solar_pv.html">Solar PV</a><a href="/r/structural_engineering.html">Structural</a><a href="/r/architecture.html">Architecture</a><a href="/blog/">Blog</a></div></nav>
{body}
<footer>
BuildLeads.ie — Dublin planning leads for trades and professionals. Data sourced from the public weekly planning lists of Dublin City Council, Fingal County Council, Dún Laoghaire-Rathdown County Council and South Dublin County Council, as required to be published under the Planning and Development Regulations 2001 (as amended).
</footer>
</body>
</html>
"""
...
<p>BuildLeads pulls the official weekly planning lists from the four Dublin councils, classifies every application by trade, and sends you only the ones that need your work. No bidding wars. No main-contractor middlemen.</p>
...
<p>Or email <a href="mailto:hello@buildleads.ie?subject=Sample">hello@buildleads.ie</a> with your trade and I'll send last week's digest free.</p>

<div class="three">
<div class="card"><h3>Public data, properly filtered</h3><p>Every application on BuildLeads is a public planning record published by your local council. We do the boring sorting work.</p></div>
<div class="card"><h3>Built for sole traders</h3><p>Existing services charge €100–€400/month and target large contractors. BuildLeads is €29/month and built for the people picking up the tools.</p></div>
...
<dd>The four Dublin local authorities publish a Weekly Planning List under statutory requirement. BuildLeads fetches those lists every Monday morning. Nothing on BuildLeads is private data.</dd>
<dt>How is this different from CIS or BCI?</dt>
<dd>Those services are excellent if you're a main contractor on a €5m project. They're overkill for a sole trader or small practice. BuildLeads does one city, one trade-relevant filter, one weekly email.</dd>
<dt>Can I see a sample?</dt>
<dd>Yes. Email hello@buildleads.ie with your trade and I'll send last week's full digest free.</dd>
<dt>What if I'm not in Dublin?</dt>
<dd>Cork, Galway and Limerick are next. Email join@buildleads.ie to be notified.</dd>
</dl>
"""
...
<p>Or email <a href="mailto:hello@buildleads.ie?subject=Sample {label}">hello@buildleads.ie</a> for last week's free.</p>
...
<h2>How it works</h2>
<ol>
<li>Every Monday at 6am, BuildLeads fetches the public weekly planning lists from the four Dublin councils.</li>
...
<dd>No. BuildLeads is the underlying public planning record — applicant name, site address, the description as published. We do not enrich with phone or personal email. You make first contact yourself, professionally, with full context about what they're planning.</dd>
<dt>How is this legal?</dt>
<dd>Planning applications are public record under the Planning and Development Act 2000 (as amended). The councils publish the same data themselves on their own websites. BuildLeads's value is filtering and delivery, not access.</dd>
<dt>Can I cancel?</dt>
